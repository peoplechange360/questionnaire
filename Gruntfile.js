module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            js: {
                src: ['web/js/main.js', 'source/vendors/bootstrap/js/collapse.js', 'source/vendors/bootstrap/js/alert.js', 'source/vendors/bootstrap/js/tab.js', 'source/vendors/Sortable/Sortable.js'],
                dest: 'web/js/main.js'
            }
        },
        jshint: {
    ...
    grunt.registerTask('default', ['concat:twig','coffee','less','cssmin','concat:js', 'uglify']);
};
